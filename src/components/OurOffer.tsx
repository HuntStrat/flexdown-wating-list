...
const OurOffer: React.FC = () => {
  return (
    <div className="w-[98%] h-auto md:h-[20vh] md:mt-10 md:ml-4 md:mr-4 flex flex-col items-start justify-between bg-gradient-to-t from-white to-white/0 rounded-[40px] px-2">
      {/* Offer Text */}
      <div className="w-full font-poppins space-y-4 px-2 md:flex flex-row justify-between">
        ...
        <p className="text-start text-l text-light-gray-400 leading-relaxed pb-4 md:w-[50%]">
