...
const WaitList = () => {
  return (
    <div className="w-full h-auto px-[2rem] pt-[1rem] flex flex-col justify-center items-center gap-[2.625rem] flex-1  border border-[#F0F0F0] bg-[#F3F3F3]">
      <div className="w-full h-auto flex-col items-start gap-[3.875rem]  self-stretch">
        {/* upperside */}
        <div className="flex  mb-[1rem] flex-col items-start gap-[1.5rem] self-stretch ">
          ...
          <div className="flex flex-col justify-center items-center gap-[1rem] self-stretch">
            <div className="flex w-full flex-col justify-center items-center gap-[0.5rem] self-stretch">
              <h1 className="text-[#161617] w-[40.82469rem] text-center text-[3rem] font-semibold leading-[150%] ">
                Smarter Deals for <br /> Modern Living
              </h1>
            ...
            <div className="flex relative  items-center   ">
              <input
                className="rounded-[6.25rem] outline-none w-[28.4375rem]  h-[2.75rem] border bg-white px-[1.5625rem] gap-[0.625rem] py-[1.525rem] "
                type="email"
                name="email"
              />
              <button
                type="submit"
                className="absolute right-0  inline-flex h-[2.75rem] py-[1.50rem] px-[1.625rem] justify-center items-center text-[#EFEFF1] text-center text-[1.125rem]  leading-normal font-semibold flex-shrink-0 bg-[#242629] rounded-[6.25rem] "
              >
                Notify me
              </button>
            </div>
        ...
        {/* lowerside */}
        <div className="flex flex-col py-[2rem] px-[1.125rem] justify-start gap-[2rem] items-end self-stretch rounded-[1rem] bg-[url('/images/background.jpeg')] bg-cover bg-center ">
          <div className="flex flex-row justify-start items-center gap-[0.75rem] self-stretch">
          ...
          <div className="w-full h-auto flex flex-row justify-end items-start gap-[1.375rem]">
            <Card
